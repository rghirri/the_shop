        ...
        <tbody>
         ...
         <tr class="cart_item">
          ...
          <td class="product-subtotal">
           <h5 class="total amount">${{ $item->getPriceSum() }}</h5>
          </td>
         ...
         <tr class="cart_item total">
          ...
          <td class="product-thumbnail">
           ...
           <div class="cart-product-content">
            <h5 class="cart-product-title">Total: ${{ number_format(Cart::getSubTotal()) }}</h5>
           </div>
       ...
       <div class="cheque">
        ...
        <div class="logos">
         <a href="#" class="logos-item">
          <img src="{{ asset('app-shop/img/visa.png') }}" alt="Visa">
         </a>
         <a href="#" class="logos-item">
          <img src="{{ asset('app-shop/img/mastercard.png') }}" alt="MasterCard">
         </a>
         <a href="#" class="logos-item">
          <img src="{{ asset('app-shop/img/discover.png') }}" alt="DISCOVER">
         </a>
         <a href="#" class="logos-item">
          <img src="{{asset('app-shop/img/amex.png') }}" alt="Amex">
         </a>
         ...
         <span style="float: right;">
          ...
          <form action="{{ route('cart.checkout') }}" method="POST">
           ...
           <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
            ...
            data-amount="{{ Cart::getSubTotal() * 100 }}" data-name="Udemy E-commerce tutorial"
